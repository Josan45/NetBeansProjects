...
public class compruebaDatos extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(tienda!=0 && cliente!=0){
            contexto.setAttribute("tienda", tienda);
            contexto.setAttribute("cliente", cliente);
            rd=contexto.getRequestDispatcher("/muestraPelisAlquilada.jsp");
