<%-- 
    Document   : ensalada
    Created on : 05-dic-2019, 16:50:43
    Author     : José Antonio
--%>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <%
            ...
            lista = DbConnection.consultaEnsalada();

        %>

        <form action="compruebaEnsalada" method="POST">
            <table width="100%" border="0">
                ...
                <tr>
                    <td></td>
                    <td style="text-align: center;">Ensalada: <br>
                            <select name="ensalada">
                                <option>------------------------</option>
                                <%
                                    for (int x = 0; x < lista.size(); x++) {%>
                                <option><% out.print(lista.get(x).getNomensaladas()); %></option>
                                <% }
                                %>
                            </select>
                            ...
                            <br><br>
                            <input type="submit" value="Elegir bebidas">
                    </td>
                            <td></td>
                            <td style="text-align: center;"><img src="images/images_2016/ensaladas.png"></td>
                </tr>
                <tr bgcolor="#990000" >
                    <td width="4%" bgcolor="#FFFFFF">&nbsp;</td>
