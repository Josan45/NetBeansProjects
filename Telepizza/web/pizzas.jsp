<%-- 
    Document   : pizzas
    Created on : 04-dic-2019, 13:31:32
    Author     : José Antonio
--%>

<%@page import="DbConnection.DbConnection"%>
<%@page import="DbConnection.pizzas"%>
    ...
    <body>
        ...
        <%
           ...
           ArrayList<pizzas> lista = new ArrayList();
            lista = DbConnection.consultaPizzas();

        %>

        <form action="compruebaPizza" method="POST">
            <table width="100%" border="0">
                ...
                <tr>
                    <td></td>
                    <td style="text-align: center;">Pizza: <br>
                            <select name="pizza">
                                <option>------------------------</option>
                                <%
                                    for (int x = 0; x < lista.size(); x++) {%>
                                <option><% out.print(lista.get(x).getNompizzas()); %></option>
                                <% }
                                %>
                            </select>
                            ...
                            <br><br>
                            <input type="submit" value="Elegir entrantes">
                    </td>
                            <td></td>
                            <td style="text-align: center;"><img src="images/images_2016/pizzas.jpg"></td>
                </tr>
                <tr bgcolor="#990000" >
                    <td width="4%" bgcolor="#FFFFFF">&nbsp;</td>
