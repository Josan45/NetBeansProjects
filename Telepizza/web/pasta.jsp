<%-- 
    Document   : pasta
    Created on : 05-dic-2019, 16:44:38
    Author     : José Antonio
--%>

<%@page import="DbConnection.DbConnection"%>
<%@page import="java.util.ArrayList"%>
<%@page import="DbConnection.pasta"%>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <%
            ...
            lista = DbConnection.consultaPasta();

        %>

        <form action="compruebaPasta" method="POST">
            <table width="100%" border="0">
                ...
                <tr>
                    <td></td>
                    <td style="text-align: center;">Pasta: <br>
                            <select name="pasta">
                                <option>------------------------</option>
                                <%
                            ...
                            <td></td>
                            <td style="text-align: center;"><img src="images/images_2016/pasta.png"></td>
                </tr>
                <tr bgcolor="#990000" >
                    <td width="4%" bgcolor="#FFFFFF">&nbsp;</td>
