<%-- 
    Document   : envios
    Created on : 05-dic-2019, 17:13:26
    Author     : José Antonio
--%>
    ...
    <body>
        ...
        <form action="compruebaPedidos" method="POST">
            <table width="100%" border="0">
                ...
                <tr style="color: red;">
                    <td></td>
                    <td align="center"><img src="images/images_2016/domicilio.gif" /></td>
                    <td align="center"><img src="images/images_2016/tienda.gif" /></td>
                    
                </tr>
                <tr style="text-align: center;">
                    <td></td>
                    <td>
                        Entrega a domicilio<input type="radio" name="pedido" value="domicilio">
                    </td>
                    <td>
                        Recoger en tienda<input type="radio" name="pedido" value="tienda">
                    </td>
                    <td></td>
                    <td></td>
                </tr>
