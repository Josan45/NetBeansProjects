<%-- 
    Document   : ofertas
    Created on : 04-dic-2019, 11:46:37
    Author     : José Antonio
--%>

<%@page import="DbConnection.DbConnection"%>
<%@page import="DbConnection.ofertas"%>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <%
            ...
            lista = DbConnection.consultaOfertas();
        %>

        <form action="compruebaOfertas" method="POST">
            <table width="100%" border="0">
                ...
                <tr style="color: red;">
                    ...
                    <td></td>
                    <td></td>
                    <td style="text-align: right;">Bienvenido <%=nombre%><br> Usted a accedido a nuestra zona de pedidos a las: <%=formatoHora.format(horaInicio)%> del <%=formatoFecha.format(fechaInicio)%></td>
                </tr>
                <tr>
                    <td></td>
                    <td style="text-align: center;">Ofertas: <br>
                            <select name="oferta">
                                <option>------------------------</option>
                                <%
                                    for (int x = 0; x < lista.size(); x++) {%>
                                <option><% out.print(lista.get(x).getDescripcion()); %></option>
                                <% }
                                %>
                            </select>
                            ...
                            <br><br>
                            <input type="submit" value="Elegir menu">
                    </td>
                            <td></td>
                        <td><img src="images/images_2016/oferta.gif"></td>
                </tr>
                <tr bgcolor="#990000" >
                    <td width="4%" bgcolor="#FFFFFF">&nbsp;</td>
