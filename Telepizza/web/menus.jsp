<%-- 
    Document   : menus
    Created on : 04-dic-2019, 13:26:51
    Author     : José Antonio
--%>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <%
            ...
            lista = DbConnection.consultaMenus();

        %>

        <form action="compruebaMenu" method="POST">
            <table width="100%" border="0">
                ...
                <tr>
                    <td></td>
                    <td style="text-align: center;">Menu: <br>
                            <select name="menu">
                                <option>------------------------</option>
                                <%
                            ...
                            <br><br>
                            <input type="submit" value="Elegir pizza">
                    </td>
                            <td></td>
                            <td style="text-align: center;"><img src="images/images_2016/menu.gif"></td>
                </tr>
                <tr bgcolor="#990000" >
                    <td width="4%" bgcolor="#FFFFFF">&nbsp;</td>
