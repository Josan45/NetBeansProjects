<%-- 
    Document   : entrantes
    Created on : 05-dic-2019, 16:33:39
    Author     : José Antonio
--%>

<%@page import="DbConnection.DbConnection"%>
<%@page import="DbConnection.entrante"%>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <%
            ...
            lista = DbConnection.consultaEntrantes();

        %>

        <form action="compruebaEntrante" method="POST">
            <table width="100%" border="0">
                ...
                <tr>
                    <td></td>
                    <td style="text-align: center;">Entrantes: <br>
                            <select name="entrante">
                                <option>------------------------</option>
                                <%
                            ...
                            <br><br>
                            <input type="submit" value="Elegir hamburguesa">
                    </td>
                            <td></td>
