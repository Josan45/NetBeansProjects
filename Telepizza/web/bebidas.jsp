<%-- 
    Document   : bebidas
    Created on : 05-dic-2019, 16:53:38
    Author     : José Antonio
--%>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <%
            ...
            lista = DbConnection.consultaBebidas();

        %>

        <form action="compruebaBebida" method="POST">
            <table width="100%" border="0">
                ...
                <tr>
                    <td></td>
                    <td style="text-align: center;">Bebidas: <br>
                            <select name="bebida">
                                <option>------------------------</option>
                                <%
                                    for (int x = 0; x < lista.size(); x++) {%>
                                <option><% out.print(lista.get(x).getNombebidas()); %></option>
                                <% }
                                %>
                            </select>
                            ...
                            <br><br>
                            <input type="submit" value="Elegir postre">
                    </td>
                            <td></td>
                            <td style="text-align: center;"><img src="images/images_2016/bebidas.png"></td>
                </tr>
                <tr bgcolor="#990000" >
                    <td width="4%" bgcolor="#FFFFFF">&nbsp;</td>
