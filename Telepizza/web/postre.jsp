<%-- 
    Document   : postre
    Created on : 05-dic-2019, 16:55:13
    Author     : José Antonio
--%>

<%@page import="DbConnection.DbConnection"%>
<%@page import="java.util.ArrayList"%>
<%@page import="DbConnection.postre"%>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <%
            ...
            lista = DbConnection.consultaPostre();

        %>

        <form action="compruebaPostre" method="POST">
            <table width="100%" border="0">
                ...
                <tr>
                    <td></td>
                    <td style="text-align: center;">Postre: <br>
                            <select name="postre">
                                <option>------------------------</option>
                                <%
                                    for (int x = 0; x < lista.size(); x++) {%>
                                <option><% out.print(lista.get(x).getNompostre()); %></option>
                                <% }
                                %>
                            </select>
                            ...
                            <td></td>
                            <td style="text-align: center;"><img src="images/images_2016/postres.png"></td>
                </tr>
                <tr bgcolor="#990000" >
                    <td width="4%" bgcolor="#FFFFFF">&nbsp;</td>
